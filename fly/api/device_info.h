...
#include <iostream>
#include <string>
#include <fly/enum/device_type.h>
...
public:
    /** @fn explicit DeviceInfo(const DeviceIndex device, const std::string& name)
      ...
      * @param device Index of device assigned by Fly framework.
    ...
    /** @fn DeviceIndex getId() const
      * Getter for index of device assigned by Fly framework.
      * @return Index of device assigned by Fly framework.
      */
