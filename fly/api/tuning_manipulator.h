...
public:
    /** @fn virtual ~TuningManipulator()
      * Tuning manipulator destructor. Inheriting class can override destructor with custom implementation. Default implementation is provided by Fly
      * framework.
      */
    ...
    /** @fn virtual void launchComputation(const KernelId id) = 0
      ...
      * times are not included in this duration (eg. duration of createArgumentBuffer() methods). Fly framework overhead and kernel compilation times
