...
public:
    /** @fn explicit PlatformInfo(const PlatformIndex platform, const std::string& name)
      ...
      * @param platform Index of platform assigned by Fly framework.
    ...
    /** @fn PlatformIndex getId() const
      * Getter for index of platform assigned by Fly framework.
      * @return Index of platform assigned by Fly framework.
      */
