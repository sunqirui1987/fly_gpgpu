/** @file output_descriptor.h
  * Functionality related to retrieving kernel output with Fly API.
  */
#pragma once
...
/** @class OutputDescriptor
  * Class which can be used to retrieve kernel argument data when calling certain Fly API methods.
  */
class  OutputDescriptor
{
public:
