...
#include <fly/compute_engine/vulkan/shaderc_compiler.h>
...
public:
        ...
        source(source)
    {
        ...
        spirvSource = ShadercCompiler::getCompiler().compile(name, source, VK_SHADER_STAGE_COMPUTE_BIT, localSize, parameterPairs);
