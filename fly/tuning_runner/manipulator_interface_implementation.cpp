#include <stdexcept>
#include <utility>
#include <fly/tuning_runner/manipulator_interface_implementation.h>
    ...
    const DimensionVector& localSize)
{
    ...
    std::vector<KernelArgument*> args = getArgumentPointers(kernelData.getArgumentIds());
    std::vector<OutputDescriptor> desc_list;
    KernelResult result = computeEngine->runKernel(kernelData, args, desc_list);
