...
#include <limits>
#include <stdexcept>
#include <fly/tuning_runner/searcher/annealing_searcher.h>
#include <fly/tuning_runner/searcher/full_searcher.h>
#include <fly/tuning_runner/searcher/random_searcher.h>
#include <fly/tuning_runner/searcher/mcmc_searcher.h>
...
const std::string ConfigurationManager::defaultParameterPackName = "FlyStandaloneParameters";
    ...
    const std::vector<KernelConfiguration>& configurations)
{
    ...
    case SearchMethod::FullSearch:
        searchers.insert(std::make_pair(id, MakeStdUnique<FullSearcher>(configurations)));
        break;
    case SearchMethod::RandomSearch:
        searchers.insert(std::make_pair(id, MakeStdUnique<RandomSearcher>(configurations)));
        break;
    case SearchMethod::Annealing:
        searchers.insert(std::make_pair(id, MakeStdUnique<AnnealingSearcher>(configurations, arguments.at(0))));
        break;
    case SearchMethod::MCMC:
        searchers.insert(std::make_pair(id, MakeStdUnique<MCMCSearcher>(configurations, arguments)));
        break;
    default:
